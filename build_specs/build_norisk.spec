...
a = Analysis(
    ...
    # Tools/Core laden Sub-Module dynamisch (importlib) — z.B. die Einstellungen-
    # Tabs (``_lazy_tab``) und die Sidebar-Tool-Registry. PyInstaller kann diese
    # dynamischen Importe statisch NICHT sehen; collect_submodules bündelt alle
    # Submodule, damit kein ``ModuleNotFoundError`` beim Öffnen eines Tabs/Tools
    # entsteht. NUR für die Haupt-App (der headless Collector bleibt Qt-frei).
